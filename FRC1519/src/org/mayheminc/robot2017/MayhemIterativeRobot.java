 ...
 */
public class MayhemIterativeRobot extends RobotBase {
	...
	private static boolean checkedInFlag = false;
	public static void checkInFMS(){
		// Tell the DS that the robot is ready to be enabled
		HAL.observeUserProgramStarting(); //this will be called later when we are ready
